...
number. [Figure 6.1.1]{.figure-ref} shows 10 random numbers from 0 to 9 generated
...
::: figText
[Figure 6.1.1]{.figure-ref} 『eStatU』 Uniform random number
:::
...
[Execute]{.button-ref} button as shown in [Figure 6.1.2]{.figure-ref}. These are the random
...
::: figText
[Figure 6.1.2]{.figure-ref} 『eStatU』 Uniform(1,50) random number generation
:::
...
and sample variance. [Figure 6.2.1]{.figure-ref} is a simulation to show the
...
::: figText
[Figure 6.2.1]{.figure-ref} Simulation to show the relationship between population
...
::: textL20M20
3\) [Table 6.2.2]{.table-ref} shows the frequency distribution of sample means in
...
::: figText
[Figure 6.2.2]{.figure-ref} Population distribution
:::

![](Figure/Fig060203.png){.imgFig400300}

::: figText
[Figure 6.2.3]{.figure-ref} Sampling distribution of 's
:::
:::
...
means in [Example 6.2.1]{.example-ref} is observed even if the population has a
different shape of distribution. If the population is very large, it is
not possible to find all possible samples as shown in [Example 6.2.1]{.example-ref}
...
modern statistics. [Figure 6.2.4]{.figure-ref} shows a simulation using 『eStatU』
...
::: figText
[Figure 6.2.4]{.figure-ref} Sampling distribution of sample means with different
...
[Figure 6.2.5]{.figure-ref} shows a simulation using 『eStatU』 that, although a
...
::: figText
[Figure 6.2.5]{.figure-ref} 『eStatU』 Simulation of the central limit theorem
:::
...
[Figure 6.2.6]{.figure-ref} shows a simulation of the 95% confidence interval for
...
::: figText
[Figure 6.2.6]{.figure-ref} 『eStatU』 Simulation of the 95% confidence interval
:::
...
flat and longer than the standard normal distribution. [Figure 6.2.7]{.figure-ref}
...
::: figText
[Figure 6.2.7]{.figure-ref} Comparison of and N(0,1)
:::
...
distribution and its value is 1.895 as [Figure 6.2.8]{.figure-ref}. In the standard
...
$t_{7:0.05}$ = 1.895 will appear as [Figure 6.2.8]{.figure-ref}.
...
::: figText
[Figure 6.2.8]{.figure-ref} Upper 5 percentile of distribution = 1.8946
:::
...
enter data at the \[Sample Data\] box as [Figure 6.2.9]{.figure-ref}. Then the
...
::: figText
[Figure 6.2.9]{.figure-ref} 『eStatU』 Estimation for population mean
:::
...
$n$ and the confidence level 1 - α as in [Figure 6.2.10]{.figure-ref}. If you
...
::: figText
[Figure 6.2.10]{.figure-ref} Simulation experiment to investigate the size of the
confidence interval
:::
...
and the sample variance of each sample are as in [Table 6.3.1]{.table-ref}.
:::
...
::: textL20
As discussed in [Example 6.2.1]{.example-ref}, the sample variance is also a random
variable that can have many values, so it is denoted as $S^2$ and the
observed sample variance as $s^2$. [Table 6.3.1]{.table-ref} shows that some of these
...
::: textL20M20
3\) [Table 6.3.2]{.table-ref} shows the frequency distribution of all possible sample
variances and [Figure 6.3.1]{.figure-ref} is its bar graph. This is called the
...
::: figText
[Figure 6.3.1]{.figure-ref} Sampling distribution of sample variances
:::
:::
...
distribution is an asymmetrical distribution as [Figure 6.3.2]{.figure-ref}. If the
...
::: figText
[Figure 6.3.2]{.figure-ref} Chi-square distributions for different degrees of
freedoms
:::

A cumulated probability and a percentile of the chi-square distribution
can be calculated by using 『eStatU』 as in [Figure 6.3.3]{.figure-ref}.
...
::: figText
[Figure 6.3.3]{.figure-ref} 『eStatU』 Chi-square distribution
:::
...
[Example 6.3.1]{.example-ref}, for an infinite population, the mean of all possible
...
::: figText
[Figure 6.3.4]{.figure-ref} 『eStatU』 Estimation of population variance
:::
...
In this module of 『eStatU』, a simulation experiment to investigate the
size of the confidence interval can be done by changing the sample size
$n$ and the confidence level 1 - α as in [Figure 6.3.5]{.figure-ref}. If you
...
::: figText
[Figure 6.3.5]{.figure-ref} 『eStatU』 simulation for the confidence interval of
...
'0' in the population consisting of 10 persons is as [Figure 6.4.1]{.figure-ref}.

![](Figure/Fig060401.png){.imgFig400300}

::: figText
[Figure 6.4.1]{.figure-ref} Population distribution of employees' satisfaction, no
for 0 or yes for 1
:::
...
proportions are as in [Table 6.4.1]{.table-ref}.
...
[Figure 6.4.2]{.figure-ref} shows the sampling distribution of all possible sample
...
::: figText
[Figure 6.4.2]{.figure-ref} Sampling distribution of sample proportions
:::
:::
...
in [Figure 6.4.3]{.figure-ref} and click the [Execute]{.button-ref} button to calculate the
...
::: figText
[Figure 6.4.3]{.figure-ref} 『eStatU』 Estimation of the population proportion
:::
...
In this module of 『eStatU』, a simulation experiment to investigate the
size of the confidence interval can be done by changing the sample size
$n$ and the confidence level 1 - α as in [Figure 6.4.4]{.figure-ref}. If you
increase $n$, the interval size becomes narrower. If you increase 1 - α,
the interval size becomes wider.
...
::: figText
[Figure 6.4.4]{.figure-ref} Simulation for estimating the population proportion
:::
:::
...
and confidence level 1-α = 0.95 as in [Figure 6.5.1]{.figure-ref}, then click the
[Execute]{.button-ref} button to calculate the sample size $n$.
...
::: figText
[Figure 6.5.1]{.figure-ref} Determination of sample size for estimating
:::
...
estimate), and the confidence level 1 - α = 0.95 as in [Figure 6.5.2]{.figure-ref},
then click the [Execute]{.button-ref} button to calculate the sample size .
...
::: figText
[Figure 6.5.2]{.figure-ref} Determination of sample size for estimating
:::
