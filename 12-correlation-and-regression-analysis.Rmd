...
::: mainTableGrey
**Example 12.2.1** In [Example 12.1.1]{.example-ref}, find the least squares
...
In [Example 12.1.1]{.example-ref}, the calculation required to obtain the intercept
...
[Figure 12.2.1]{.figure-ref} shows the fitted regression line on the original data.
...
::: figText
[Figure 12.2.1]{.figure-ref} Simple linear regression using 『eStat』
:::
...
determination, it is convenient to make the following [Table 12.2.1]{.table-ref}.
...
In [Table 12.2]{.table-ref}.1, $\small SST$ = 396.1, $\small SSR$ = 378.429,
...
graph of [Figure 12.2.1]{.figure-ref} to show the coefficient of determinations and
estimation errors shown in [Figure 12.2.2]{.figure-ref}.

![](Figure/Fig120202.png){.imgFig600400}

::: figText
[Figure 12.2.2]{.figure-ref} Correlation and descriptive statistics
:::
...
mean squares, and [Table 12.2.2]{.table-ref} defines the regression mean squares
...
Using the sum of squares calculated in [Example 12.2.2]{.example-ref}, the ANOVA
...
below the graph [Figure 12.2.1]{.figure-ref} to show the result of the ANOVA as
shown in [Figure 12.2.3]{.figure-ref}.

![](Figure/Fig120203.png){.imgFig600400}

::: figText
[Figure 12.2.3]{.figure-ref} Regression Analysis of Variance using 『eStat』
:::
:::
...
regression graph of [Figure 12.2.1]{.figure-ref}, you can see the confidence band
...
in [Figure 12.2.5]{.figure-ref}.
:::

![](Figure/Fig120204.svg){.imgFig600400}

::: figText
[Figure 12.2.4]{.figure-ref} Confidence band using 『eStat』
:::

![](Figure/Fig120205.png){.imgFig600400}

::: figText
[Figure 12.2.5]{.figure-ref} Testing hypothesis of regression coefficients
:::
:::
...
regression graph of [Figure 12.2.1]{.figure-ref}, the scatter plot of the
standardized residuals and predicted values are appeared as shown in
[Figure 12.2.6]{.figure-ref}. If you click \[Residual Q-Q Plot\] button, \<Figure
...
::: figText
[Figure 12.2.6]{.figure-ref} Residual plot
:::

![](Figure/Fig120207.svg){.imgFig600400}

::: figText
[Figure 12.2.7]{.figure-ref} Residual Q-Q Plot
:::
:::
...
regression line is affected by an extreme point ([Figure 12.2.8]{.figure-ref}). A
...
::: figText
[Figure 12.2.8]{.figure-ref} Simulation experiment of regression analysis at
『eStatU』
:::
...
::: presentation-video-link
[presentation](pdf/1203.pdf){.presentation-link target="_blank"}   
...
relatively easy to measure. The data in [Table 12.3.1]{.table-ref} are the values for
...
[Figure 12.3.1]{.figure-ref}. It can be observed that there is a high correlation
...
::: figText
[Figure 12.3.1]{.figure-ref} Scatterplot matrix
:::
...
::: figText
[Figure 12.3.2]{.figure-ref} Correlation matrix
:::
...
### Goodness of Fit for Regression and Analysis of Variance
...
::: mainTableGrey
**Example 12.3.2** For the tree data of [Example 12.3.1]{.example-ref}, obtain the
...
estimated regression line, ANOVA table as shown in [Figure 12.3.3]{.figure-ref} in
...
The $p$-value calculated from the ANOVA table in [Figure 12.3.3]{.figure-ref} at
...
::: figText
[Figure 12.3.3]{.figure-ref} Result of Multiple Linear Regression
:::

Since $\small {SE}(b_1 ) = 0.003, \; {SE} (b_2 ) = 0.008$ and
$t_{12; 0.025}$ = 2.179 from the result in [Figure 12.3.3]{.figure-ref}, the 95%
confidence intervals for each regression coefficients can be calculated
as follows: The difference between this result and the [Figure 12.3.3]{.figure-ref}
...
12.3.4\> and the Q-Q scatter plot is shown in [Figure 12.3.5]{.figure-ref}. There
...
::: figText
[Figure 12.3.4]{.figure-ref} Residual analysis of multiple linear regression
:::

![](Figure/Fig120305.svg){.imgFig600400}

::: figText
[Figure 12.3.5]{.figure-ref} Q-Q plot of multiple linear regression
:::
:::
