...
[Figure 4.3.6]{.figure-ref}. In this Figure, dot mark represents each data value.
...
::: figText
[Figure 4.3.6]{.figure-ref} Calculation of a population variance
:::
...
These values coincide with the output of 『eStat』 in [Figure 4.3.3]{.figure-ref}
and the output of 『eStatU』 in [Figure 4.3.4]{.figure-ref}.
:::
...
[Figure 4.3.3]{.figure-ref} and the output of 『eStatU』 in [Figure 4.3.4]{.figure-ref}.
:::
...
IQR) as in [Figure 4.3.3]{.figure-ref}. Using the box plot, you can check a
...
\* in [Figure 4.3.7]{.figure-ref}). Some statistical packages display the left line
...
::: figText
[Figure 4.3.7]{.figure-ref} box plot
:::
:::
...
『eStatU』 , if you enter the data and click the [Execute]{.button-ref} button, the
dot plot and the box plot appear as in [Figure 4.3.8]{.figure-ref}.

![](Figure/Fig040308.png){.imgFig600400}

::: figText
[Figure 4.3.8]{.figure-ref} Dot graph and box plot of the data
:::
:::
...
horizontal box plot is appeared as in [Figure 4.3.9]{.figure-ref}. If you select
'Vertical' from the options below the graph, the vertical box plot shown
as in [Figure 4.3.10]{.figure-ref} is appeared. Based on this box plot, we can see
...
::: figText
[Figure 4.3.9]{.figure-ref} Horizontal box plot of age variable
:::

![](Figure/Fig040310.svg){.imgFig600540}

::: figText
[Figure 4.3.10]{.figure-ref} Vertical box plot of age variable
:::

::: textL20
If you click button of \[Descriptive Statistics\] in the options, the
basic statistics of the age is displayed as shown in [Figure 4.3.11]{.figure-ref}.
:::

![](Figure/Fig040311.png){.imgFig400100}

::: figText
[Figure 4.3.11]{.figure-ref} Descriptive statistics of age variable
:::

::: textL20M20
2\) If you click on 'Gender' after 'Age' variable, the horizontal
box plot by gender appears as shown in [Figure 4.3.12]{.figure-ref}. If you select
'Vertical' from the options below the graph, the vertical box plot by
gender appears as shown in [Figure 4.3.13]{.figure-ref}. You can observe that
...
::: figText
[Figure 4.3.12]{.figure-ref} Horizontal box plot of age by gender
:::

![](Figure/Fig040313.svg){.imgFig600540}

::: figText
[Figure 4.3.13]{.figure-ref} Vertical box plot of age by gender
:::
...
[Figure 4.3.14]{.figure-ref}.
:::

![](Figure/Fig040314.png){.imgFig600200}

::: figText
[Figure 4.3.14]{.figure-ref} Descriptive statistics of age by gender
:::
:::
