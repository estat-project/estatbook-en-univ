...
::: figText
[Figure 10.2.1]{.figure-ref} Data input at『eStat』
:::
...
mean will appear as in [Figure 10.2.2]{.figure-ref}. Average score of students in
...
distribution curves for each department, as in[Figure 10.2.3]{.figure-ref}.
:::

![](Figure/Fig100202.svg){.imgFig600400}

::: figText
[Figure 10.2.2]{.figure-ref} Dot graph and confidence interval by department
:::

![](Figure/Fig100203.svg){.imgFig600400}

::: figText
[Figure 10.2.3]{.figure-ref} Histogram by department
:::
...
data in ascending order as shown in [Table 10.2.1]{.table-ref}. The sum of ranks
...
${}_{13}P_{6}$ = 1716 as shown in [Table 10.2.2]{.table-ref}. It is not easy to
...
shown in [Figure 10.2.4]{.figure-ref}.
:::
...
::: figText
[Figure 10.2.4]{.figure-ref} Wilcoxon rank sum distribution when =7, =6
:::
...
::: textL20M20
3\) In『eStatU』, enter the data as [Figure 10.2.5]{.figure-ref} and click the
[Execute]{.button-ref} button. It will calculate the sample statistics and show the
test result graph as [Figure 10.2.6]{.figure-ref}. The two critical lines which
...
::: figText
[Figure 10.2.5]{.figure-ref} Data input for the Wilcoxon rank sum test at『eStatU』
:::
...
::: figText
[Figure 10.2.6]{.figure-ref} Wilcoxon rank sum test using 『eStatU』
:::

::: textL20
The rank sum test can be performed using『eStat』. After you saw
[Figure 10.2.2]{.figure-ref}, click the \[Wilcoxon Rank Sum Test\] button in the
options window below the graph. Then a test result graph as shown in
[Figure 10.2.6]{.figure-ref} will appear in the Graph Area and a test result table
as in [Figure 10.2.7]{.figure-ref} will appear in the Log Area.
:::

![](Figure/Fig100207.png){.imgFig600400}

::: figText
[Figure 10.2.7]{.figure-ref} Result table of Wilcoxon rank sum test
:::
:::
...
is often used as an approximation. [Table 10.2.4]{.table-ref} summarizes the decision
...
following mean $E(R_2 )$ and variance $V(R_2 )$: $$
        ...
        \end{align}
      $$ [Table 10.2.5]{.table-ref} summarizes the decision rule for each hypothesis
...
### Paired Samples: Wilcoxon Signed Rank Sum Test
...
hypothesis for a population mean) is as in [Figure 10.2.8]{.figure-ref}. If you
...
::: figText
[Figure 10.2.8]{.figure-ref} Histogram of age difference
:::
...
shown in [Figure 10.2.9]{.figure-ref} and [Table 10.2.8]{.table-ref}.
:::
...
::: textL20M20
3\) Enter the data as shown in [Figure 10.2.9]{.figure-ref} in『eStat』and click
...
[Execute]{.button-ref} button, you will see the test result as in[Figure 10.2.10]{.figure-ref}
and [Figure 10.2.11]{.figure-ref}. Two critical lines for values containing 2.5
...
::: figText
[Figure 10.2.9]{.figure-ref} Data difference
:::
...
::: figText
[Figure 10.2.10]{.figure-ref} 『eStat』Signed rank sum test
:::

![](Figure/Fig100211.png){.imgFig600400}

::: figText
[Figure 10.2.11]{.figure-ref} Result of Wilcoxon signed rank sum test
:::
:::
...
values near $w_{+}(n)_{α}$ is used approximately. [Table 10.2]{.table-ref}.9
...
distribution approximation formula shown in [Table 10.1.6]{.table-ref}.
:::
...
## Nonparametric Test for Comparing Locations of Several Populations
...
::: textL20
Enter the data as shown in [Figure 10.3.1]{.figure-ref} in『eStat』.
:::
...
::: figText
[Figure 10.3.1]{.figure-ref} 『eStat』data input
:::
...
[Figure 10.3.2]{.figure-ref}. Company C has the high average of satisfaction
...
in[Figure 10.3.3]{.figure-ref}.
:::

![](Figure/Fig100302.svg){.imgFig600400}

::: figText
[Figure 10.3.2]{.figure-ref} Dot graph and the confidence interval by company
:::

![](Figure/Fig100303.svg){.imgFig600400}

::: figText
[Figure 10.3.3]{.figure-ref} Histogram by company
:::
...
$n_2$ = 3, and $n_3$ = 3 as shown in [Figure 10.3.4]{.figure-ref}, and a part of
the distribution table as in [Table 10.3.2]{.table-ref}. As shown in the figure, the
...
::: figText
[Figure 10.3.4]{.figure-ref} Kruskal Wallis H distribution when
$n_1 = 4, n_2 = 3, n_3 = 3$
:::
...
::: textL20M20
3\) In 『eStatU』, enter data as [Figure 10.3.5]{.figure-ref} and click the
[Execute]{.button-ref} button. Then the sample statistics are calculated and the
test result is shown as in [Figure 10.3.6]{.figure-ref}. The critical line for
...
::: figText
[Figure 10.3.5]{.figure-ref} 『eStatU』 Kruskal-Wallis test
:::
...
::: figText
[Figure 10.3.6]{.figure-ref} Kruskal-Wallis test
:::

::: textL20
『eStat』 can also be used to conduct the Kruskal--Wallis $\small H$
test. Enter data as [Figure 10.3.1]{.figure-ref} and click the ANOVA icon. Select
...
table will appear as in [Figure 10.3.7]{.figure-ref}.
:::

![](Figure/Fig100307.png){.imgFig600400}

::: figText
[Figure 10.3.7]{.figure-ref} Result of the Kruskal-Wallis test
:::
...
sample must be created. [Table 10.3.4]{.table-ref} is a notation of ranking data for
each level.
:::
...
Chapter 9 by using the ranking data in [Table 10.3.4]{.table-ref} are as follows: $$
        \begin{align}
...
$k-1$ degrees of freedom. [Table 10.3.6]{.table-ref} summarizes the decision rule for
...
Let us take a look at the Friedman test using [Example 9.2.1]{.example-ref} which
was the car fuel mileage measurement problem.
:::

::: mainTableGrey
**Example 10.3.2** The fuel mileage of the three types of cars (A, B and
C) is measured using the randomized block design as [Table 9.2.4]{.table-ref} and it
is rearranged in [Table 10.3.7]{.table-ref}.
...
::: textL20
1\) Enter data in『eStat』as shown in [Figure 10.3.8]{.figure-ref}.
:::
...
::: figText
[Figure 10.3.8]{.figure-ref} 『eStat』Data input
:::
...
as shown in [Figure 10.3.9]{.figure-ref}.
:::

![](Figure/Fig100309.svg){.imgFig600400}

::: figText
[Figure 10.3.9]{.figure-ref} Histogram of fuel mileage by car
:::
...
the case of $n$ = 5, $k$ = 3 as in [Figure 10.3.10]{.figure-ref} and its
distribution table as [Table 10.3.9]{.table-ref}. As shown in the graph, the
...
::: figText
[Figure 10.3.10]{.figure-ref} Friedman S distribution when ,
:::
...
::: textL20M20
3\) Enter data in『eStatU』as in [Figure 10.3.11]{.figure-ref} and click the
[Execute]{.button-ref} button. The sample statistics and test graph will be shown
as in [Figure 10.3.12]{.figure-ref}. The critical line which contains 5% of the
...
::: figText
[Figure 10.3.11]{.figure-ref} Data input for Friedman test at『eStatU』
:::
...
::: figText
[Figure 10.3.12]{.figure-ref} Result of Friedman test using『eStatU』
:::
:::
...
created. [Table 10.3.11]{.table-ref} is the notation of ranking data for each level.
:::
...
::: mainTable
If we apply the analysis of variance for the rank data of [Table 10.3]{.table-ref}.11
...
approximately. [Table 10.3.12]{.table-ref} is the summary of decision rule of the
Friedman test.
:::
...
$k-1$ degrees of freedom. [Table 10.3.13]{.table-ref} summarizes the decision rule for
