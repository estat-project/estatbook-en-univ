...
In [Table 13.3.3]{.table-ref}, it can be seen that the production quantity of iron
...
[Table 13.3.4]{.table-ref} shows the monthly consumer price index for the past two
years and time lag 1 to 12 for this data, and the autocorrelation
coefficients are shown in [Table 13.3.5]{.table-ref}. [Figure 13.3.3]{.figure-ref} shows the
original time series and the autocorrelation function.

::: textLeft
[Table 13.3.4]{.table-ref} Monthly Consumer Price Index and Time Lag 1, Lag 2,
\... Lag 12
:::
...
::: textLeft
[Table 13.3.5]{.table-ref} Autocorrelation Function
:::
...
::: figText
[Figure 13.3.3]{.figure-ref} Autocorrelation Function Graph
:::
...
::: mainTable
Since the price index in [Table 13.3.4]{.table-ref} has a linear trend, a model
...
[Figure 13.3.4]{.figure-ref} shows the first order differencing of [Table 13.3.4]{.table-ref}
...
::: figText
[Figure 13.3.4]{.figure-ref} 1st Order Differencing of Consumer Price Index
:::
...
[Table 13.3.6]{.table-ref} is a toy company's quarterly sales, and \<Figure
...
reduce the dispersion as time increases, as shown in [Figure 13.3.5]{.figure-ref},
...
::: textLeft
[Table 13.3.6]{.table-ref} Quarterly Sales of a Toy Company (unit million \$)
:::
...
::: figText
[Figure 13.3.5]{.figure-ref} Log Transformation of Toy Sales
:::
...
Korea's GDP from 1986 to 2021 is shown in [Table 13.4.1]{.table-ref}. \<Figure
...
::: textLeft
[Table 13.4.1]{.table-ref} GDP of Korea
:::
...
::: figText
[Figure 13.4.1]{.figure-ref} GDP of Korea and Three Regression Model
:::
...
## Exponential Smoothing Model and Forecasting
...
shown in [Table 13.5.1]{.table-ref}, and the residual between the raw data and the
predicted value of one point in time was calculated by obtaining a
six-point moving average. [Figure 13.5.1]{.figure-ref} shows the time series for
...
as shown in [Table 13.5.1]{.table-ref}, so the mean square error is as follows: $$
...
::: textLeft
[Table 13.5.1]{.table-ref} Montly Sales of a Furniture Company and 6-point Moving
...
::: figText
[Figure 13.5.1]{.figure-ref} Montly Sales of a Furniture Company and 6-point Moving
...
To the data of [Table 13.5.1]{.table-ref}, predict sales for the next three months
...
points, the predicted values after one time point, and the residuals are
as shown in [Table 13.5.2]{.table-ref}. Therefore, the mean square error is as
follows:
...
[Table 13.5.2]{.table-ref} summarizes the above equations, and [Figure 13.5.2]{.figure-ref}
...
::: textLeft
[Table 13.5.2]{.table-ref} Exponential Smoothing with α = 0.1, One Time Forecast
and Residual
:::
...
::: figText
[Figure 13.5.2]{.figure-ref} Exponential Smoothing with α = 0.1 and One Time
Forecast
:::
...
linear trend in [Table 13.5.3]{.table-ref} is predicted after one point in time
...
::: figText
[Figure 13.5.3]{.figure-ref} 5-pt Moving Average of Consumer Price Index with
Linear Trend
:::
...
[Table 13.5.3]{.table-ref} is a calculation table for predicting the consumer
...
::: textLeft
[Table 13.5.3]{.table-ref} Double Moving Average of Consumer Price Index and One
Time Forecast
:::
...
::: figText
[Figure 13.5.4]{.figure-ref} Forecast using Double Moving Average of Consumer Price
Index
:::
...
13.5.4\] is as follows: $$
      ...
      $$ [Table 13.5.4]{.table-ref} is a calculation table for predicting the
...
::: textLeft
[Table 13.5.4]{.table-ref} Forecasting using Holt Double Exponential Smoothing
...
[Figure 13.5.5]{.figure-ref} shows the predicted values using the Holt's double
...
::: figText
[Figure 13.5.5]{.figure-ref} Forecasting using Holt Double Exponential Smoothing
Model of CPI
:::
...
## Seasonal Model and Forecasting
...
[Table 13.6.1]{.table-ref} shows a company's quarterly sales. Since the seasonal
...
::: textLeft
[Table 13.6.1]{.table-ref} Quarterly Sales of a Company
:::
...
[Table 13.6.2]{.table-ref} shows the seasonal ratio by year and quarter. If the
...
::: textLeft
[Table 13.6.2]{.table-ref} Seasonal Index
:::
...
Column 6 of [Table 13.6.1]{.table-ref} shows the non-seasonal data $D_t$ obtained
...
([Figure 13.6.1]{.figure-ref})., $$
      ...
      $$ Therefore, the forecast for the next one year is as follows. $$
        ...
        \end{align}
      $$ [Figure 13.6.2]{.figure-ref} is a graph of seasonal forecasts.
...
::: figText
[Figure 13.6.1]{.figure-ref} Forcasting Model of Deseasonal Sales of a Company
:::
...
::: figText
[Figure 13.6.2]{.figure-ref} Forcasting of Quarterly Sales of a Company
:::
...
[Table 13.6.3]{.table-ref} calculates exponential smoothing values of level,
...
::: textLeft
[Table 13.6.3]{.table-ref} Holt-Winters Forecasting Model of Quarterly Sales
:::
...
[Figure 13.6.3]{.figure-ref} is the Holt-Winters forecast for the next one year and
is calculated as follows: $$
        \begin{align}
...
::: figText
[Figure 13.6.3]{.figure-ref} Holt-Winters Forecasting of Quarterly Sales
:::
