...
::: figText
[Figure 8.2.4]{.figure-ref} Data input for testing two population variances
:::
...
::: figText
[Figure 8.2.5]{.figure-ref} Dot graph and mean-standard deviation interval of each
group
:::
...
as in [Figure 8.2.7]{.figure-ref} appears in the Log Area.

![](Figure/Fig080206.png){.imgFig600540}

::: figText
[Figure 8.2.6]{.figure-ref} Testing hypothesis for two population variances
:::

![](Figure/Fig080207.png){.imgFig600400}

::: figText
[Figure 8.2.7]{.figure-ref} Result table of testing two population variances
:::
:::
...
## Testing Hypothesis for Two Population Proportions

::: presentation-video-link
[presentation](pdf/0803.pdf){.presentation-link target="_blank"}   
...
shown in [Figure 8.3.1]{.figure-ref}. Clicking the [Execute]{.button-ref} button will show the
result of the hypothesis test as shown in [Figure 8.3.2]{.figure-ref}.
...
::: figText
[Figure 8.3.1]{.figure-ref} Data input for testing two population proportions in
『eStatU』
:::
