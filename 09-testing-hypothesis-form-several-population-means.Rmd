...
::: mainTable
Data such as English scores by the grade in [Example 9.1.1]{.example-ref} are not so
...
completely randomized design of experiments. [Table 9.2.1]{.table-ref} shows an
...
is known as a randomized block design. [Table 9.2.2]{.table-ref} shows an example of
...
::: mainTableGrey
**Example 9.2.1** [Table 9.2.4]{.table-ref} is the rearrangement of the fuel mileage
data in [Table 9.2.2]{.table-ref} measured by five drivers and car types.
...
::: textL20M20
1\) In 『eStat』, enter data as shown in [Figure 9.2.1]{.figure-ref} and click the
...
::: figText
[Figure 9.2.1]{.figure-ref} Data input for randomized block design for 『eStat』
ANOVA
:::
...
::: figText
[Figure 9.2.2]{.figure-ref} Dot graph and 95% confidence interval for population
...
reveal the ANOVA graph as in [Figure 9.2.3]{.figure-ref} and the ANOVA table as in
[Figure 9.2.4]{.figure-ref}. The result of the ANOVA is that there is no difference
in fuel mileage between the cars of each company. The same is true for
the multiple comparison tests in [Figure 9.2.5]{.figure-ref}.

![](Figure/Fig090203.svg){.imgFig600400}

::: figText
[Figure 9.2.3]{.figure-ref} ANOVA of gas milage
:::

![](Figure/Fig090204.png){.imgFig600400}

::: figText
[Figure 9.2.4]{.figure-ref} ANOVA table of gas milage
:::

![](Figure/Fig090205.png){.imgFig600400}

::: figText
[Figure 9.2.5]{.figure-ref} Multiple comparisons by car
:::
:::
...
fuel mileage for each car type as shown in [Figure 9.2.6]{.figure-ref}. This
scatter plot shows a significant difference in fuel mileage per driver.

![](Figure/Fig090206.svg){.imgFig600400}

::: figText
[Figure 9.2.6]{.figure-ref} Fuel mileages for each driver
:::
:::

::: textL20
Click the \[ANOVA F-Test\] button in the options window below the graph
to reveal the two-way mean table shown in [Figure 9.2.7]{.figure-ref} and the ANOVA
table shown in [Figure 9.2.8]{.figure-ref}. This ANOVA table clearly shows a
...
::: figText
[Figure 9.2.7]{.figure-ref} Two-way mean table by car and driver\
...
::: figText
[Figure 9.2.8]{.figure-ref} ANOVA table for randomized block design
:::
...
::: mainTableGrey
**Example 9.3.1** [Table 9.3.1]{.table-ref} shows the yield data of three repeated
...
combination of two factors are shown in [Table 9.3.2]{.table-ref}. Denote the $k^{th}$
...
data as [Figure 9.3.1]{.figure-ref} where the fertilizer is variable 1, the rice
...
::: figText
[Figure 9.3.1]{.figure-ref} Data input for two-way ANOVA of 『eStat』
:::
...
will appear as in [Figure 9.3.2]{.figure-ref}. In addition, the average yields at
...
::: figText
[Figure 9.3.2]{.figure-ref} Yields by rice types and fertilizer types
:::
:::
...
The result of the two-way analysis of variances is as [Table 9.3.3]{.table-ref}.
:::
...
[Figure 9.3.2]{.figure-ref} of『eStat』, the two-dimensional table of means /
standard deviations for each level combination as in [Figure 9.3.3]{.figure-ref}
and the two-way analysis of variance table as in [Figure 9.3.4]{.figure-ref} will
...
::: figText
[Figure 9.3.3]{.figure-ref} Two dimensional mean / standard deviation table
:::

![](Figure/Fig090304.png){.imgFig600400}

::: figText
[Figure 9.3.4]{.figure-ref} two-way analysis of variance table
:::
:::
...
::: mainTable
The two-way analysis of variance is summarized as [Table 9.3.4]{.table-ref}.
...
block design as [Table 9.2.3]{.table-ref}.
:::
