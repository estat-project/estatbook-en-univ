...
'expected probability' in [Table 11.1]{.table-ref}.4, as shown in \<Figure 11.1.9\>.
...
\<Figure 11.2.3\> and press the [Execute]{.button-ref} button to display the result
...
::: textL20M20
3\) In the independence test of『eStatU』, enter data as shown in
\<Figure 11.2.7\> and click the [Execute]{.button-ref} button to display the result
