...
::: textL20M20
1\) Enter the data in『eStat』 as shown in [Figure 11.2.5]{.figure-ref}.
:::
...
::: figText
[Figure 11.2.5]{.figure-ref} Data input
:::
...
order, then the line graph shown in [Figure 11.2.6]{.figure-ref} will appear. If
...
::: figText
[Figure 11.2.6]{.figure-ref} Line graph by region and beverage
:::
...
::: textL20M20
3\) In the independence test of『eStatU』, enter data as shown in
[Figure 11.2.7]{.figure-ref} and click the [Execute]{.button-ref} button to display the result
of the chi-square test as shown in [Figure 11.2.8]{.figure-ref}.
:::
...
::: figText
[Figure 11.2.7]{.figure-ref} Data input for Independence Test at『eStatU』
:::
...
::: figText
[Figure 11.2.8]{.figure-ref} Chi-square Independence Test at『eStatU』
:::
:::

::: mainTable
As described in Chapter 4, if a contingency table is made using raw data
([Figure 11.2.9]{.figure-ref}), 『eStat』provides the result of the independence
test as shown in [Figure 11.2.10]{.figure-ref}. In this case, if a cell of the
...
::: figText
[Figure 11.2.9]{.figure-ref} Raw data input for independence test
:::

![](Figure/Fig110210.png){.imgFig600400}

::: figText
[Figure 11.2.10]{.figure-ref}『eStat』contingency table and independence test
:::
:::
...
::: presentation-video-link
[presentation](pdf/110202.pdf){.presentation-link target="_blank"}   
