...
binomial function graph as shown in \<Figure 5.3.4\>. [Table 5.3.4]{.table-ref} shows
...
for 100 days as in [Table 5.4.1]{.table-ref}. \<Figure 5.4.1\> is a histogram of this
table.
:::
...
as \<Figure 5.4.16\> and click the [Execute]{.button-ref} button. The probability
is 0.3935.
:::

::: textL20M20
2\) Similarly, enter 10 at the box of the third option below the
distribution graph as \<Figure 5.4.16\> and click the [Execute]{.button-ref}
