...
$\small X$ usually denoted as f(x). [Figure 5.3.1]{.figure-ref} is a graph of f(x).
:::
...
::: figText
[Figure 5.3.1]{.figure-ref} Probability distribution function of the random
...
::: figText
[Figure 5.3.2]{.figure-ref} Cumulative distribution function of the random variable
$\small X$ = 'Number of Heads' when tossing a coin twice'
:::
...
variable $\small X$ = 'Number of Heads' when tossing a coin twice'
which described in [Table 5.3.2]{.table-ref}.
...
::: presentation-video-link
[presentation](pdf/050301.pdf){.presentation-link target="_blank"}   
...
a 1/2 chance such as [Figure 5.3.3]{.figure-ref}. The same experiment is repeated
...
::: figText
[Figure 5.3.3]{.figure-ref} Simulation of Binomial distribution
:::
...
probability distribution function of [Example 5.3.4]{.example-ref}.

**Answer**

Select 'Binomial Distribution' from the menu of 『eStatU』 and enter
$\small n = 4, p = 0.6$ and press the [Execute]{.button-ref} button to display a
binomial function graph as shown in [Figure 5.3.4]{.figure-ref}. [Table 5.3.4]{.table-ref} shows
...
::: figText
[Figure 5.3.4]{.figure-ref} 『eStatU』 Binomial distribution graph when
$\small n = 4, p = 0.6$
:::
...
(success probability) are called parameters. [Figure 5.3.5]{.figure-ref} shows a
...
::: figText
[Figure 5.3.5]{.figure-ref} Binomial distribution for various n and p
:::
...
$n=10, p=0.2$, and click on the [Execute]{.button-ref} button to display the graph
shown in [Figure 5.3.6]{.figure-ref}. Checking 'Show Probability' option shows
...
::: figText
[Figure 5.3.6]{.figure-ref} 『eStatU』 Binomial distribution when $n = 10, p = 0.2$
:::
...
distribution table shown in [Table 5.3.6]{.table-ref}. From here you can see that
...
『eStatU』 and click on the [Execute]{.button-ref} button, the graph such as
[Figure 5.3.7]{.figure-ref} appears. If you click the \[Binomial Prob Table\]
button, then [Table 5.3.6]{.table-ref} appears.
...
::: figText
[Figure 5.3.7]{.figure-ref} 『eStatU』 Binomial Distribution when
$n = 50, p = 0.05$
:::
...
calculated by using the [Table 5.3.6]{.table-ref} as P(X \\ge 3) = 0.4595. You may
...
::: presentation-video-link
[presentation](pdf/050302.pdf){.presentation-link target="_blank"}   
...
5.3.8\> to [Figure 5.3.11]{.figure-ref} show the Poisson distributions for
...
::: figText
[Figure 5.3.8]{.figure-ref} Poisson Distribution when λ = 0.4
:::
...
::: figText
[Figure 5.3.9]{.figure-ref} Poisson Distribution when λ = 1.0
:::

![](Figure/Fig050310.png){.imgFig600600}

::: figText
[Figure 5.3.10]{.figure-ref} Poisson Distribution when λ = 1.5
:::

![](Figure/Fig050311.png){.imgFig600600}

::: figText
[Figure 5.3.11]{.figure-ref} Poisson Distribution when λ = 2.0
:::
...
= 2.5. Then click on the [Execute]{.button-ref} button to display a graph such as
[Figure 5.3.12]{.figure-ref} and click the \[Poisson Prob Table\] button to see the
Table 5.3.7.

![](Figure/Fig050312.png){.imgFig600600}

::: figText
[Figure 5.3.12]{.figure-ref} 『eStatU』 Poisson Distribution when λ = 2.5
:::
...
::: textL20M20
3\) If you use [Table 5.3]{.table-ref}.7, $\small P(X \ge 2)$ = 0.7127. Then the
...
::: presentation-video-link
[presentation](pdf/050303.pdf){.presentation-link target="_blank"}   
...
::: mainTable
[Figure 5.3.13]{.figure-ref} to [Figure 5.3.15]{.figure-ref} show the distribution of
...
::: figText
[Figure 5.3.13]{.figure-ref} Geometric distribution when $p$ = 0.2
:::
...
::: figText
[Figure 5.3.14]{.figure-ref} Geometric distribution when $p$ = 0.5
:::

![](Figure/Fig050315.svg){.imgFig600600}

::: figText
[Figure 5.3.15]{.figure-ref} Geometric distribution when $p$ = 0.8
:::
...
parameter $p$ = 0.05, and click the [Execute]{.button-ref} button to display the
graph shown in [Figure 5.3.16]{.figure-ref}, and click the \[Geometric Prob Table\]
button to display [Table 5.3.8]{.table-ref}.

![](Figure/Fig050316.svg){.imgFig600600}

::: figText
[Figure 5.3.16]{.figure-ref} Geometric distribution when $p$ = 0.05
:::
...
::: presentation-video-link
[presentation](pdf/050304.pdf){.presentation-link target="_blank"}   
...
called parameters of the distribution and [Figure 5.3.17]{.figure-ref} to \<Figure
...
::: figText
[Figure 5.3.17]{.figure-ref} Hypergeometric distribution when
$N = 30, D = 5, n = 10$
:::
...
::: figText
[Figure 5.3.18]{.figure-ref} Hypergeometric distribution when
$N = 100, D = 5, n = 10$
:::
...
::: figText
[Figure 5.3.19]{.figure-ref} Hypergeometric distribution when
$N = 100, D = 5, n = 20$
:::
...
select $N = 20, D = 15, n = 3$ and click on the [Execute]{.button-ref} button to
display a graph such as [Figure 5.3.20]{.figure-ref}. If you click the
\[Hypergeometric Prob Table\] button, [Table 5.3.9]{.table-ref} appears. This table
...
::: figText
[Figure 5.3.20]{.figure-ref} Hypergeometric distribution when
$N = 20, D = 5, n = 3$
:::
...
::: presentation-video-link
[presentation](pdf/0504.pdf){.presentation-link target="_blank"}   
...
for 100 days as in [Table 5.4.1]{.table-ref}. [Figure 5.4.1]{.figure-ref} is a histogram of this
table.
:::
...
::: figText
[Figure 5.4.1]{.figure-ref} Histogram of $\small X$ = 'commuting time'
:::
...
table and a histogram such as [Figure 5.4.2]{.figure-ref} which has narrower
...
approximated to a continuous function as shown in [Figure 5.4.3]{.figure-ref}. This
...
::: figText
[Figure 5.4.2]{.figure-ref} Histogram with narrower intervals on many data
:::

![](Figure/Fig050403.png){.imgFig400300}

::: figText
[Figure 5.4.3]{.figure-ref} Probability distribution function of a continuous
random variable
:::
...
between ($a,b)$ of f(x) as [Figure 5.4.4]{.figure-ref} which is the integral over
($a,b)$ as follows: $$
...
::: figText
[Figure 5.4.4]{.figure-ref} $P(a \lt X \lt b)$ of the continuous random variable
$\small X$
:::
...
[Figure 5.4.5]{.figure-ref} is the shape of this probability distribution function
...
::: figText
[Figure 5.4.5]{.figure-ref} Uniform distribution on (10,30) and the probability of
$P(15 \lt X \lt 20)$
:::

The probability of the delivery time between 15 and 20 minutes is the
area of the shaded rectangle of the [Figure 5.4.5]{.figure-ref} which can be
...
::: presentation-video-link
[presentation](pdf/050401.pdf){.presentation-link target="_blank"}   
...
bell-shape as in [Figure 5.4.3]{.figure-ref}. The graph shows that large amount of
...
distribution. [Figure 5.4.6]{.figure-ref} shows a simulation of data which follow a
...
::: figText
[Figure 5.4.6]{.figure-ref} Simulation of data which follow a Normal distribution
...
$N(\mu, \sigma^2)$. [Figure 5.4.7]{.figure-ref} shows three normal distributions,
N(-2,0.25), N(0,1), and N(2,4) simultaneously.

![](Figure/Fig050407.png){.imgFig400300}

::: figText
[Figure 5.4.7]{.figure-ref} Three Normal distribution N(-2,0.25), N(0,1), N(2,4)
:::
...
interval $(a,b)$ as shown in [Figure 5.4.8]{.figure-ref}.

![](Figure/Fig050408.png){.imgFig400300}

::: figText
[Figure 5.4.8]{.figure-ref} Probability of $\small X$ on the interval $(a,b)$
:::
...
calculated by using a computer and summarized as [Table 5.4.2]{.table-ref}. It is
called the standard normal distribution table and [Table 5.4.2]{.table-ref} is a part
...
be done as in [Figure 5.4.9]{.figure-ref}, and the percentile $x$ for a given
...
::: figText
[Figure 5.4.9]{.figure-ref} Normal probability calculation using 『eStatU』
:::
...
By using normal distribution module of 『eStatU』 ([Figure 5.4.9]{.figure-ref}),

::: textL20M20
1\) Enter 1.96 on the second option below the graph, then click the
[Execute]{.button-ref} button. The answer is shown at the yellow box in the right
hand side
:::

::: textL20M20
2\) Enter an interval from -1.96 and 1.96 on the first option below the
graph, then click the [Execute]{.button-ref} button.
:::
...
graph, then click the [Execute]{.button-ref} button. It shows that the exact 90
percentile is 1.282 at the yellow box.
:::

::: textL20M20
2\) Enter $p =$ 0.99 at the right box of the fourth option below the
graph, then click the [Execute]{.button-ref} button. You can see that the exact
two-sided value is --2.576 and 2.576 at the yellow boxes .
:::

::: textL20M20
3\) Enter $p =$ 0.05 at the right box of the sixth option below the
graph, then click the [Execute]{.button-ref} button. It shows that the right 5
...
::: figText
[Figure 5.4.10]{.figure-ref} Percentile with a cumulative probability of 95%,
97.5%, and 99.5% from the left end of N(0,1)
:::

::: mainTable
[Figure 5.4.11]{.figure-ref} shows a value of 95% and 99% when two ends are
excluded equally.
:::
...
::: figText
[Figure 5.4.11]{.figure-ref} Percentile with a probability of 95%, 97.5%, and 99.5%
...
::: figText
[Figure 5.4.12]{.figure-ref} Probability calculation of $N(70,10^2 )$ distribution
:::
...
graph and then click the [Execute]{.button-ref} button.
:::
:::

::: mainTableGrey
**Example 5.4.5** In [Example 5.4.4]{.example-ref}, obtain the following percentiles
...
screen as [Figure 5.4.13]{.figure-ref}.

::: textL20M20
1\) Enter 0.95 at the box of the fifth option below the graph and click
the [Execute]{.button-ref} button to display the 95 percentile as 86.449.
:::
...
::: figText
[Figure 5.4.13]{.figure-ref} Percentile calculation of $N(70,10^2 )$ distribution
:::
...
the [Execute]{.button-ref} button to display the two-sided 95 percentile as
(50.400, 89.600).
:::
:::
...
::: presentation-video-link
[presentation](pdf/050402.pdf){.presentation-link target="_blank"}   
...
discrete probability distributions. [Figure 5.4.14]{.figure-ref} and \<Figure
...
::: figText
[Figure 5.4.14]{.figure-ref} Exponential distribution when λ = 1.0
:::
...
::: figText
[Figure 5.4.15]{.figure-ref} Exponential distribution when λ = 5.0
:::
...
Click the [Execute]{.button-ref} button to reveal the graph shown as \<Figure
5.4.16\>.
...
::: figText
[Figure 5.4.16]{.figure-ref} Exponential distribution when λ = 10.0
:::
...
as [Figure 5.4.16]{.figure-ref} and click the [Execute]{.button-ref} button. The probability
is 0.3935.
:::

::: textL20M20
2\) Similarly, enter 10 at the box of the third option below the
distribution graph as [Figure 5.4.16]{.figure-ref} and click the [Execute]{.button-ref}
