...
### Raw Data of Categorical Variable
...
as a column as in [Table 2.3.1]{.table-ref} with numeric coding (1: male, 2: female).
...
Data of [Table 2.3.1]{.table-ref} are saved at the following address in 『eStat』
system.
...
Enter the gender data of [Table 2.3.1]{.table-ref} on the sheet of 『eStat』 system or
load the file from  Ex  ⇨ eBook ⇨ EX020301_Raw_Gender.csv.

If you enter the data, give a variable name 'Gender' using \[Edit
Var\] button as shown in [Figure 2.3.1]{.figure-ref} and provide value labels to
...
::: figText
[Figure 2.3.1]{.figure-ref} Value label using [Edit Var]{.button-ref}
:::
...
shown in [Figure 2.3.2]{.figure-ref}. A bar graph was drawn after counting
...
such as [Figure 2.3.2]{.figure-ref} is frequently used. If there are a large number
...
::: figText
[Figure 2.3.2]{.figure-ref} Vertical bar graph of gender
:::

![](Figure/Fig020303.svg){.imgFig600540}

::: figText
[Figure 2.3.3]{.figure-ref} Horizontal bar graph of gender
:::

Click on the pie chart icon
![](Icon/eStat_icon10_pie.png){.imgIcon} in 『eStat』 to draw a
pie chart ([Figure 2.3.4]{.figure-ref}) and click on the band graph icon
![](Icon/eStat_icon11_band.png){.imgIcon} to draw a band graph
([Figure 2.3.5]{.figure-ref}). Click on the icon to draw a doughnut graph.

![](Figure/Fig020304.svg){.imgFig600540}

::: figText
[Figure 2.3.4]{.figure-ref} Pie chart of gender
:::

![](Figure/Fig020305.svg){.imgFig600540}

::: figText
[Figure 2.3.5]{.figure-ref} Band graph of gender
:::
:::
...
### Raw Data of Categorical Variable with Group
...
Single 2: Married, 3: Other) was also surveyed as in [Table 2.3.2]{.table-ref}.
...
Enter the gender and marital status data of [Table 2.3.2]{.table-ref} on the sheet of
『eStat』 system. Use [Edit Var]{.button-ref} button to enter a variable name as
...
status by gender is drawn as in [Figure 2.3.6]{.figure-ref}.

![](Figure/Fig020306.svg){.imgFig600540}

::: figText
[Figure 2.3.6]{.figure-ref} Vertical bar graph of marital status by gender
:::
...
2.3.7\>), a ratio ([Figure 2.3.8]{.figure-ref}),
![](Icon/eStat_icon37_VbarRatio.png){.imgIcon} a side-by-side
([Figure 2.3.9]{.figure-ref}) ![](Icon/eStat_icon38_VbarSide.png){.imgIcon},
...
([Figure 2.3.13]{.figure-ref}), a side-by-side
![](Icon/eStat_icon43_HbarSide.png){.imgIcon} ([Figure 2.3.14]{.figure-ref}),
a bi-lateral ![](Icon/eStat_icon44_HbarBilateral.png){.imgIcon}
([Figure 2.3.15]{.figure-ref}).

![](Figure/Fig020307.svg){.imgFig600540}

::: figText
[Figure 2.3.7]{.figure-ref} Vertical stacked bar graph of marital status by gender
:::

![](Figure/Fig020308.svg){.imgFig600540}

::: figText
[Figure 2.3.8]{.figure-ref} Vertical proportional bar graph of marital status by
gender
:::
...
::: figText
[Figure 2.3.9]{.figure-ref} Vertical side by side bar graph of marital status by
gender
:::
...
::: figText
[Figure 2.3.10]{.figure-ref} Vertical bi-lateral bar graph of marital status by
gender
:::
...
::: figText
[Figure 2.3.11]{.figure-ref} Horizontal bar graph of marital status by gender
:::

![](Figure/Fig020312.svg){.imgFig600540}

::: figText
[Figure 2.3.12]{.figure-ref} Horizontal stacked bar graph of marital status by
gender
:::
...
::: figText
[Figure 2.3.13]{.figure-ref} Horizontal proportional bar graph of marital status by
gender
:::
...
::: figText
[Figure 2.3.14]{.figure-ref} Horizontal side by side bar graph of marital status by
gender
:::
...
::: figText
[Figure 2.3.15]{.figure-ref} Horizontal bi-lateral bar graph of marital status by
gender
:::

Click on the pie chart ![](Icon/eStat_icon10_pie.png){.imgIcon}
and band graph icons ![](Icon/eStat_icon11_band.png){.imgIcon} and
in 『eStat』 to draw a pie chart as in [Figure 2.3.16]{.figure-ref} and a band
graph as in [Figure 2.3.17]{.figure-ref}. It is easy to observe which categories in
each group account for a large percentage of the total data.

![](Figure/Fig020316.svg){.imgFig600540}

::: figText
[Figure 2.3.16]{.figure-ref} Pie chart of marital status by gender
:::

![](Figure/Fig020317.svg){.imgFig600540}

::: figText
[Figure 2.3.17]{.figure-ref} Band graph of marital status by gender
:::
:::
...
Copy the sample text to [Data Input]{.button-ref} text area and click [Execute]{.button-ref}
...
::: figText
[Figure 2.4.1]{.figure-ref} Word cloud on the description of data science
:::
:::
